  ...
  return (
    <div>
      <PageTitle
        ...
        actions={
          <>
            <a href={`/api/companies/${params.id}/export.pdf`} className="btn-secondary">PDF</a>
            <a href={`/api/companies/${params.id}/export.docx`} className="btn-secondary">DOCX</a>
            <a href={`/api/companies/${params.id}/export.md`} className="btn-secondary">Markdown</a>
            <a href={`/api/companies/${params.id}/export.csv`} className="btn-secondary">Buyer CSV</a>
            <a href={`/api/companies/${params.id}/export-outreach.csv`} className="btn-secondary">Outreach CSV</a>
